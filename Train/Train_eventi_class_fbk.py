...
# The code use the word embeddings from Tonelli et al. 2017. To obtain the embeddings please contact: satonelli@fbk.eu
...
######################################################
datasets = {
#    'eventi_class_gold_fbk':                                   #Name of the dataset
    'eventi_class_fbk':                                   #Name of the dataset
...
embeddingsPath = 'dh-fbk_100dim.txt'
