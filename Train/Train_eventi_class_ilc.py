...
from util.preprocessingv2 import perpareDataset, loadDatasetPickle
...
######################################################
datasets = {
#    'eventi_class_gold_ilc':                                   #Name of the dataset
    'eventi_class_ilc':                                   #Name of the dataset
...
embeddingsPath = 'itwac_embeddings.txt'
