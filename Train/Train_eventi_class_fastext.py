...
# The code use the Fastext embeddings (Italian version) based on Bojanovski ey al. 2016
# git link original embeddings: https://s3-us-west-1.amazonaws.com/fasttext-vectors/wiki.it.vec
# direct link to the embeddings used: https://drive.google.com/open?id=1CogluUdT9Upja7kSrY5K8ww-mQdHjX5h
...
######################################################
datasets = {
#    'eventi_class_gold_fastext':                                   #Name of the dataset
     'eventi_class_fastext':  # Name of the dataset
