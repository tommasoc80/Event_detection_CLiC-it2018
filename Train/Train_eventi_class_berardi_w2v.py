...
# The code use the word2vec embeddings by Beraredi et al. (https://drive.google.com/open?id=1PNkIWtowksvsBo3FQHoCuksP53ojZFlu)
...
######################################################
datasets = {
#    'eventi_class_gold_berardi_w2v':                                   #Name of the dataset
    'eventi_class_berardi_w2v':  # Name of the dataset
...
embeddingsPath = 'berardi_wiki_w2v_300.txt'
